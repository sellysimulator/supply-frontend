...
| Ring | `#1D4ED8` | `--color-ring` |

**Color Notes:** Professional blue, single accent hue. Overridden from the
generator's green palette at the user's request: minimal, modern, formal, blue.
**No color gradients anywhere** — flat fills only, no `linear-gradient`, no
`bg-gradient-to-*`, no gradient text or overlays. Success green `#047857` is
reserved for the "published" badge and is not a general accent.
